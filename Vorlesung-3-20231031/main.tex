...
\sol{
    ...
    Genauso (Symetrie) $\left[a_2\right]_R \subset\left[a_1\right]_R$ \qed
}
\\
\cor{}{Ist $R$ Aquivalenzrelation auf $A \neq \varnothing$. Dann sind $a_1, a_2 \in A$ entweder äquivalent oder sie gehōren zu disjunkten Äquivalenzrelation.}
